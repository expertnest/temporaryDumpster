...
bg-[linear-gradient(to_right,#2F4D72_1px,transparent_1px),linear-gradient(to_bottom,#2F4D72_1px,transparent_1px)]
...
bg-[radial-gradient(circle_at_center,transparent_0%,rgba(15,23,42,0.05)_100%)]
"
/>
