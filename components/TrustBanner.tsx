          ...
          <div className="flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="w-full xl:max-w-sm">
              ...
              <p className="mt-2 text-sm font-medium leading-relaxed text-white/70">
                Reliable service, fast delivery, and the right dumpster solution
                for every project.
              </p>
            </div>
                  ...
                  <div
                    ...
                    ${
                      index !== stats.length - 1
                        ? "xl:border-r xl:border-brand-accent"
                        : ""
                    }
                    `}
                  >
                    ...
                    <div>
                      ...
                      <p className="mt-1 whitespace-nowrap text-[10px] font-extrabold uppercase tracking-wider text-white/70">
                        {item.label}
                      </p>
                    </div>
                  </div>
