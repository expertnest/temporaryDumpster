      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <div className="grid gap-12 2xl:grid-cols-[38%_62%] 2xl:items-center">
          ...
          <div className="w-full">
            ...
            {/* RESPONSIVE BENEFITS */}
            <div className="mt-7 grid gap-4 lg:grid-cols-2 2xl:grid-cols-1">

              {benefits.map((item) => (

                <div
                  key={item}
                  className="flex items-start gap-3 border-l-2 border-brand-accent pl-4"
                >
                  ...
                  <span className="max-w-lg text-sm font-semibold leading-relaxed text-white/80">
                    {item}
                  </span>
